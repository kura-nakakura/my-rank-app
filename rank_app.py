...
【{safe_ind}】の【{safe_job}】志望者を事実に基づき評価と提出資料を元に企業様がお会いしたくなるような書類作成の準備をしてください。ただし自己PR、志望動機、推薦文は「」や・””などAIのような文章はさけてください。
...
実績：{achievement_text}\n資料：{file_contents}"""
                ...
                if total_score >= 15:
                    ...
                    st.success("safe **【エージェント指示】** 優先度：中　あなたの腕の見せ所です。紹介企業や書類作成によって内定の可能性はあります。")
                elif total_score < 7:
